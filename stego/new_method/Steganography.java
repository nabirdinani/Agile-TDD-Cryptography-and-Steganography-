...
"Target File cannot hold message!", "Error",JOptionPane.ERROR_MESSAGE);
	...
	private byte[] bit_conversion(int i)
	{
		...
		//byte byte3 = (byte)((i & 0xFF00000000000000L) >>> 56);
		//byte byte2 = (byte)((i & 0x00FF000000000000L) >>> 48);
		//byte byte1 = (byte)((i & 0x0000FF0000000000L) >>> 40);
		//byte byte0 = (byte)((i & 0x000000FF00000000L) >>> 32);
	...
	private byte[] decode_text(byte[] image)
	{
		...
		for(int b=0; b<result.length; ++b )
		{
			...
			for(int i=0; i<8; ++i, ++offset)
			{
				...
				result[b] = (byte)((result[b] << 1) | ((image[offset] & 2)/2));
			} 	
		}
		return result;
	}
